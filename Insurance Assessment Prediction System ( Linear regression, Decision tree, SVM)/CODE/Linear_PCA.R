...
lm_pca_model<-lm(Response ~., data = train)

predictResponse_lm_pca_model <- predict(lm_pca_model,test)
MeanSquareError_lm_pca = sqrt(mean((as.numeric(predictResponse_lm_pca_model)-as.numeric(train$Response))^2))

MeanSquareError_lm_pca
